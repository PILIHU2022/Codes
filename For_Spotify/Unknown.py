...
eason_filesname_without_extension = []

for music_filename in music_in_dir:
    music_without_extension = os.path.splitext(music_filename)[0]
    if "" in music_without_extension:
        eason_filesname_without_extension.append(music_without_extension)

uri_of_files = []

for filename_without_extension in eason_filesname_without_extension:
