...
# 源路径
home_source_pathes = (
    "/home/PILIHU/.config/nvim",
    "/home/PILIHU/.config/dunst",
    "/home/PILIHU/.config/hypr",
    "/home/PILIHU/.config/ranger",
    "/home/PILIHU/.zprofile",
    "/home/PILIHU/.zshrc",
    "/home/PILIHU/.zprofile",
    "/home/PILIHU/.config/zsh.d",
)
etc_source_pathes = (
    "/etc/clash-meta",
    "/etc/doas.conf",
...
while 1 + 1 == 2:
    for home_source_path in home_source_pathes:
        ...
        os.system(
            "notify-send '已将文件复制到/Back_up/My-Config/config文件夹,详情见~/Backup.py'"
        )
    time.sleep(1800)
...
while 2 + 2 == 4:
    for etc_source_path in etc_source_pathes:
        ...
        os.system(
            "notify-send '已将文件复制到/Back_up/My-Config/etc文件夹,详情见~/Backup.py'"
        )
    time.sleep(1800)
